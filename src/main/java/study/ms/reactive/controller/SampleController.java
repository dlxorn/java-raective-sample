...
public class SampleController {
  ...
  @GetMapping
  public Mono<String> getSample(ServerWebExchange exchange, ServerHttpRequest request) {
  ...
  public Mono<String> postSampleWithMonoDTO(@RequestBody  SampleDTO sampleDTOMono) {
